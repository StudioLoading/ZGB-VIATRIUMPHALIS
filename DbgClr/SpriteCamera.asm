...
;--------------------------------------------------------
	...
	C$SpriteCamera.c$11$0_0$178	= .
	.globl	C$SpriteCamera.c$11$0_0$178
;SpriteCamera.c:11: void START() {
;	---------------------------------
; Function Start_SpriteCamera
; ---------------------------------
_Start_SpriteCamera::
	C$SpriteCamera.c$12$1_0$178	= .
	.globl	C$SpriteCamera.c$12$1_0$178
...
___bank_SpriteCamera	=	0x00ff
	...
	C$SpriteCamera.c$16$1_0$179	= .
	.globl	C$SpriteCamera.c$16$1_0$179
...
;	spillPairReg hl
	...
	ld	a, d
	ld	(bc), a
	C$SpriteCamera.c$18$2_0$180	= .
	.globl	C$SpriteCamera.c$18$2_0$180
;SpriteCamera.c:18: INT8 delta_x = 0;
	ldhl	sp,	#0
	ld	(hl), #0x00
	C$SpriteCamera.c$17$1_2$179	= .
	.globl	C$SpriteCamera.c$17$1_2$179
;SpriteCamera.c:17: THIS->y = s_horse->y - 18;
	ld	hl, #_THIS
	ld	a, (hl+)
	ld	e, a
	...
	ld	a, (hl+)
	ld	b, (hl)
	C$SpriteCamera.c$20$1_2$179	= .
	.globl	C$SpriteCamera.c$20$1_2$179
;SpriteCamera.c:20: UINT16 final_camera_x = s_horse->x + 56;
	...
	inc	b
00178$:
	C$SpriteCamera.c$23$1_2$179	= .
	.globl	C$SpriteCamera.c$23$1_2$179
...
;SpriteCamera.c:23: if(THIS->x > final_camera_x_max){delta_x=-4;}
	...
	ld	a, (de)
	ld	(hl), a
	C$SpriteCamera.c$19$1_1$180	= .
	.globl	C$SpriteCamera.c$19$1_1$180
...
00180$:
	jr	NC, 00107$
	C$SpriteCamera.c$20$2_1$181	= .
	.globl	C$SpriteCamera.c$20$2_1$181
;SpriteCamera.c:20: UINT16 final_camera_x = s_horse->x + 56;
	ldhl	sp,#3
	ld	a, (hl+)
	ld	e, a
	...
	ld	e, l
	ld	d, h
	C$SpriteCamera.c$21$2_1$181	= .
	.globl	C$SpriteCamera.c$21$2_1$181
;SpriteCamera.c:21: UINT16 final_camera_x_min = final_camera_x -8;
	...
	adc	a, #0xff
	ld	b, a
	C$SpriteCamera.c$22$2_1$181	= .
	.globl	C$SpriteCamera.c$22$2_1$181
;SpriteCamera.c:22: UINT16 final_camera_x_max = final_camera_x +8;
	ld	hl, #0x0008
	add	hl, de
	ld	e, l
	ld	d, h
	C$SpriteCamera.c$23$2_1$181	= .
	.globl	C$SpriteCamera.c$23$2_1$181
;SpriteCamera.c:23: if(THIS->x > final_camera_x_max){delta_x=-4;}
	ldhl	sp,	#5
	ld	a, e
	sub	a, (hl)
	...
	jr	00107$
00104$:
	C$SpriteCamera.c$24$2_1$181	= .
	.globl	C$SpriteCamera.c$24$2_1$181
;SpriteCamera.c:24: else if(THIS->x < final_camera_x_min){delta_x=+4;}
	...
	ld	(hl), #0x04
00107$:
	C$SpriteCamera.c$26$1_1$180	= .
	.globl	C$SpriteCamera.c$26$1_1$180
;SpriteCamera.c:26: if(vx < -1){
	ld	a, (#_vx)
	xor	a, #0x80
	sub	a, #0x7f
	jr	NC, 00114$
	C$SpriteCamera.c$27$2_1$184	= .
	.globl	C$SpriteCamera.c$27$2_1$184
;SpriteCamera.c:27: UINT16 final_camera_x = s_horse->x - 40;
	...
	ld	b, a
	ld	c, e
	C$SpriteCamera.c$28$2_1$184	= .
	.globl	C$SpriteCamera.c$28$2_1$184
;SpriteCamera.c:28: UINT16 final_camera_x_min = final_camera_x -8;
	...
	adc	a, #0xff
	ld	d, a
	C$SpriteCamera.c$29$2_1$184	= .
	.globl	C$SpriteCamera.c$29$2_1$184
;SpriteCamera.c:29: UINT16 final_camera_x_max = final_camera_x +8;
	ld	l, #0x08
	add	hl, bc
	ld	c, l
	ld	b, h
	C$SpriteCamera.c$30$2_1$184	= .
	.globl	C$SpriteCamera.c$30$2_1$184
;SpriteCamera.c:30: if(THIS->x > final_camera_x_max){delta_x=-4;}
	...
	jr	00114$
00111$:
	C$SpriteCamera.c$31$2_1$184	= .
	.globl	C$SpriteCamera.c$31$2_1$184
;SpriteCamera.c:31: else if(THIS->x < final_camera_x_min){delta_x=+4;}
	...
	ld	(hl), #0x04
00114$:
	C$SpriteCamera.c$33$1_2$187	= .
	.globl	C$SpriteCamera.c$33$1_2$187
;SpriteCamera.c:33: INT16 camera_horse_delta_x = THIS->x - s_horse->x;
	...
	ld	c, e
	ld	b, a
	C$SpriteCamera.c$34$1_2$187	= .
	.globl	C$SpriteCamera.c$34$1_2$187
...
00182$:
	jr	NC, 00116$
	C$SpriteCamera.c$35$2_2$188	= .
	.globl	C$SpriteCamera.c$35$2_2$188
;SpriteCamera.c:35: THIS->x += delta_x;
	...
	jr	00119$
00116$:
	C$SpriteCamera.c$36$2_2$189	= .
	.globl	C$SpriteCamera.c$36$2_2$189
;SpriteCamera.c:36: }else{THIS->x += vx;}
	...
	ld	(hl), b
00119$:
	C$SpriteCamera.c$37$1_2$179	= .
	.globl	C$SpriteCamera.c$37$1_2$179
;SpriteCamera.c:37: }
	add	sp, #7
	C$SpriteCamera.c$37$1_2$179	= .
	.globl	C$SpriteCamera.c$37$1_2$179
	...
	C$SpriteCamera.c$39$1_2$191	= .
	.globl	C$SpriteCamera.c$39$1_2$191
;SpriteCamera.c:39: void DESTROY() {
;	---------------------------------
; Function Destroy_SpriteCamera
; ---------------------------------
_Destroy_SpriteCamera::
	C$SpriteCamera.c$40$1_2$191	= .
	.globl	C$SpriteCamera.c$40$1_2$191
;SpriteCamera.c:40: }
	C$SpriteCamera.c$40$1_2$191	= .
	.globl	C$SpriteCamera.c$40$1_2$191
