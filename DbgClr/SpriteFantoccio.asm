...
;--------------------------------------------------------
	...
	C$SpriteFantoccio.c$19$0_0$191	= .
	.globl	C$SpriteFantoccio.c$19$0_0$191
;SpriteFantoccio.c:19: void START() {
;	---------------------------------
; Function Start_SpriteFantoccio
; ---------------------------------
_Start_SpriteFantoccio::
	C$SpriteFantoccio.c$20$1_0$191	= .
	.globl	C$SpriteFantoccio.c$20$1_0$191
;SpriteFantoccio.c:20: SetSpriteAnim(THIS, a_fantoccio_hit, 24);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteFantoccio.c$21$1_0$191	= .
	.globl	C$SpriteFantoccio.c$21$1_0$191
;SpriteFantoccio.c:21: THIS->mirror = NO_MIRROR;
	...
	add	hl, bc
	ld	(hl), #0x00
	C$SpriteFantoccio.c$22$1_0$191	= .
	.globl	C$SpriteFantoccio.c$22$1_0$191
;SpriteFantoccio.c:22: fantoccio_turned = 0;
	ld	hl, #_fantoccio_turned
	ld	(hl), #0x00
	C$SpriteFantoccio.c$23$1_0$191	= .
	.globl	C$SpriteFantoccio.c$23$1_0$191
;SpriteFantoccio.c:23: THIS->lim_x = 1000;
	...
	ld	(hl+), a
	ld	(hl), #0x03
	C$SpriteFantoccio.c$24$1_0$191	= .
	.globl	C$SpriteFantoccio.c$24$1_0$191
;SpriteFantoccio.c:24: THIS->lim_y = 1000;
	...
	ld	(hl+), a
	ld	(hl), #0x03
	C$SpriteFantoccio.c$25$1_0$191	= .
	.globl	C$SpriteFantoccio.c$25$1_0$191
...
_a_fantoccio_hit:
	...
	C$SpriteFantoccio.c$27$1_0$193	= .
	.globl	C$SpriteFantoccio.c$27$1_0$193
;SpriteFantoccio.c:27: void UPDATE() {
;	---------------------------------
; Function Update_SpriteFantoccio
; ---------------------------------
_Update_SpriteFantoccio::
	C$SpriteFantoccio.c$28$1_0$193	= .
	.globl	C$SpriteFantoccio.c$28$1_0$193
;SpriteFantoccio.c:28: }
	...
	C$SpriteFantoccio.c$30$1_0$195	= .
	.globl	C$SpriteFantoccio.c$30$1_0$195
;SpriteFantoccio.c:30: void DESTROY() {
;	---------------------------------
; Function Destroy_SpriteFantoccio
; ---------------------------------
_Destroy_SpriteFantoccio::
	C$SpriteFantoccio.c$31$1_0$195	= .
	.globl	C$SpriteFantoccio.c$31$1_0$195
