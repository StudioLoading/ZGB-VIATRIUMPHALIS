...
;--------------------------------------------------------
	...
	C$SpriteItem.c$37$0_0$191	= .
	.globl	C$SpriteItem.c$37$0_0$191
;SpriteItem.c:37: void START() {
;	---------------------------------
; Function Start_SpriteItem
; ---------------------------------
_Start_SpriteItem::
	C$SpriteItem.c$38$1_0$191	= .
	.globl	C$SpriteItem.c$38$1_0$191
...
_a_item_cape:
	...
	C$SpriteItem.c$44$1_0$192	= .
	.globl	C$SpriteItem.c$44$1_0$192
...
;SpriteItem.c:46: switch(item_data->configured){
	...
	or	a, a
	jp	Z,00129$
	C$SpriteItem.c$49$1_0$192	= .
	.globl	C$SpriteItem.c$49$1_0$192
...
;SpriteItem.c:85: item_data->vy = vy;
	...
	ldhl	sp,	#10
	ld	(hl), a
	C$SpriteItem.c$100$1_0$192	= .
	.globl	C$SpriteItem.c$100$1_0$192
...
;SpriteItem.c:46: switch(item_data->configured){
	...
	sub	a, #0x04
	jp	Z,00120$
	C$SpriteItem.c$47$2_0$193	= .
	.globl	C$SpriteItem.c$47$2_0$193
...
00247$:
	...
	jp	00109$
	jp	00110$
	C$SpriteItem.c$50$3_0$194	= .
	.globl	C$SpriteItem.c$50$3_0$194
...
;SpriteItem.c:72: SetSpriteAnim(THIS, a_item_time, 64);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteItem.c$74$2_0$193	= .
	.globl	C$SpriteItem.c$74$2_0$193
;SpriteItem.c:74: }
00111$:
...
;SpriteItem.c:78: switch(item_data->itemtype){
	...
	jr	Z, 00118$
	jr	00119$
	C$SpriteItem.c$79$3_0$195	= .
	.globl	C$SpriteItem.c$79$3_0$195
...
;SpriteItem.c:97: SetSpriteAnim(THIS, a_item_cape, 32);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteItem.c$99$2_0$193	= .
	.globl	C$SpriteItem.c$99$2_0$193
;SpriteItem.c:99: }
00119$:
	C$SpriteItem.c$100$2_0$193	= .
	.globl	C$SpriteItem.c$100$2_0$193
;SpriteItem.c:100: item_data->hp = 80;
	ldhl	sp,	#11
	ld	a,	(hl+)
	ld	h, (hl)
	ld	l, a
	ld	(hl), #0x50
	C$SpriteItem.c$101$2_0$193	= .
	.globl	C$SpriteItem.c$101$2_0$193
;SpriteItem.c:101: item_data->configured = 4;
	...
	ld	l, a
	ld	(hl), #0x04
	C$SpriteItem.c$102$2_0$193	= .
	.globl	C$SpriteItem.c$102$2_0$193
;SpriteItem.c:102: break;
	jp	00129$
	C$SpriteItem.c$103$2_0$193	= .
	.globl	C$SpriteItem.c$103$2_0$193
;SpriteItem.c:103: case 4://weapon in use!
00120$:
	C$SpriteItem.c$104$2_0$193	= .
	.globl	C$SpriteItem.c$104$2_0$193
;SpriteItem.c:104: switch(item_data->itemtype){
	...
	sub	a, #0x08
	jp	NZ,00129$
	C$SpriteItem.c$107$3_0$196	= .
	.globl	C$SpriteItem.c$107$3_0$196
;SpriteItem.c:107: case CAPE:
00123$:
	C$SpriteItem.c$108$3_0$196	= .
	.globl	C$SpriteItem.c$108$3_0$196
;SpriteItem.c:108: THIS->x = s_horse->x;
	...
	ld	(hl+), a
	ld	(hl), b
	C$SpriteItem.c$109$3_0$196	= .
	.globl	C$SpriteItem.c$109$3_0$196
...
;	spillPairReg hl
	...
	ld	a, d
	ld	(bc), a
	C$SpriteItem.c$110$3_0$196	= .
	.globl	C$SpriteItem.c$110$3_0$196
;SpriteItem.c:110: item_data->hp--;
	...
	ld	h, a
	ld	(hl), c
	C$SpriteItem.c$111$3_0$196	= .
	.globl	C$SpriteItem.c$111$3_0$196
...
00261$:
	jr	C, 00129$
	C$SpriteItem.c$112$4_0$197	= .
	.globl	C$SpriteItem.c$112$4_0$197
;SpriteItem.c:112: consume_weapon_def();
	ld	e, #b_consume_weapon_def
	ld	hl, #_consume_weapon_def
	call	___sdcc_bcall_ehl
	C$SpriteItem.c$113$4_0$197	= .
	.globl	C$SpriteItem.c$113$4_0$197
;SpriteItem.c:113: SpriteManagerRemoveSprite(THIS);
	...
	C$SpriteItem.c$115$3_0$196	= .
	.globl	C$SpriteItem.c$115$3_0$196
;SpriteItem.c:115: break;
	jr	00129$
	C$SpriteItem.c$116$3_0$196	= .
	.globl	C$SpriteItem.c$116$3_0$196
;SpriteItem.c:116: case LANCE:
00126$:
	C$SpriteItem.c$117$3_0$196	= .
	.globl	C$SpriteItem.c$117$3_0$196
...
00265$:
	...
	C$SpriteItem.c$121$1_0$192	= .
	.globl	C$SpriteItem.c$121$1_0$192
;SpriteItem.c:121: }
00129$:
	C$SpriteItem.c$122$1_0$192	= .
	.globl	C$SpriteItem.c$122$1_0$192
;SpriteItem.c:122: }
	add	sp, #13
	C$SpriteItem.c$122$1_0$192	= .
	.globl	C$SpriteItem.c$122$1_0$192
	...
	C$SpriteItem.c$124$1_0$199	= .
	.globl	C$SpriteItem.c$124$1_0$199
;SpriteItem.c:124: void DESTROY() {
;	---------------------------------
; Function Destroy_SpriteItem
; ---------------------------------
_Destroy_SpriteItem::
	C$SpriteItem.c$125$1_0$199	= .
	.globl	C$SpriteItem.c$125$1_0$199
;SpriteItem.c:125: }
	C$SpriteItem.c$125$1_0$199	= .
	.globl	C$SpriteItem.c$125$1_0$199
