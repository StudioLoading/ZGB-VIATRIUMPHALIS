...
;--------------------------------------------------------
	...
	C$SpriteStep.c$12$0_0$164	= .
	.globl	C$SpriteStep.c$12$0_0$164
...
;SpriteStep.c:14: THIS->lim_y = 1u;
	...
	ld	(hl+), a
	ld	(hl), #0x00
	C$SpriteStep.c$15$1_0$164	= .
	.globl	C$SpriteStep.c$15$1_0$164
...
;SpriteStep.c:16: struct ItemData* step_data = (struct ItemData*) THIS->custom_data;
	...
	ld	c, a
	ld	b, (hl)
	C$SpriteStep.c$17$1_1$165	= .
	.globl	C$SpriteStep.c$17$1_1$165
;SpriteStep.c:17: step_data->hp = 40u;
	ld	hl,#0x1d
	add	hl,bc
	ld	(hl), #0x28
	C$SpriteStep.c$18$1_1$164	= .
	.globl	C$SpriteStep.c$18$1_1$164
;SpriteStep.c:18: }
	C$SpriteStep.c$18$1_1$164	= .
	.globl	C$SpriteStep.c$18$1_1$164
...
_a_steponwater:
	...
	C$SpriteStep.c$20$1_1$166	= .
	.globl	C$SpriteStep.c$20$1_1$166
...
;SpriteStep.c:25: step_data->hp--;
	...
	dec	a
	ld	(bc), a
	C$SpriteStep.c$26$1_0$166	= .
	.globl	C$SpriteStep.c$26$1_0$166
;SpriteStep.c:26: if(step_data->hp == 0){
	or	a, a
	ret	NZ
	C$SpriteStep.c$27$2_0$168	= .
	.globl	C$SpriteStep.c$27$2_0$168
;SpriteStep.c:27: SpriteManagerRemoveSprite(THIS);
	ld	hl, #_THIS
	ld	e, (hl)
	inc	hl
	ld	d, (hl)
	C$SpriteStep.c$29$1_0$166	= .
	.globl	C$SpriteStep.c$29$1_0$166
;SpriteStep.c:29: }
	C$SpriteStep.c$29$1_0$166	= .
	.globl	C$SpriteStep.c$29$1_0$166
	...
	C$SpriteStep.c$31$1_0$170	= .
	.globl	C$SpriteStep.c$31$1_0$170
;SpriteStep.c:31: void DESTROY(){
;	---------------------------------
; Function Destroy_SpriteStep
; ---------------------------------
_Destroy_SpriteStep::
	C$SpriteStep.c$33$1_0$170	= .
	.globl	C$SpriteStep.c$33$1_0$170
;SpriteStep.c:33: }
	C$SpriteStep.c$33$1_0$170	= .
	.globl	C$SpriteStep.c$33$1_0$170
