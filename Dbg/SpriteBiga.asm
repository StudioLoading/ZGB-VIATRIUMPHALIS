...
;--------------------------------------------------------
	...
	C$SpriteBiga.c$40$0_0$179	= .
	.globl	C$SpriteBiga.c$40$0_0$179
;SpriteBiga.c:40: void START() {
;	---------------------------------
; Function Start_SpriteBiga
; ---------------------------------
_Start_SpriteBiga::
	C$SpriteBiga.c$41$1_0$179	= .
	.globl	C$SpriteBiga.c$41$1_0$179
;SpriteBiga.c:41: SetSpriteAnim(THIS, a_biga_h, 32u);
	...
	ld	d, (hl)
	call	_SetSpriteAnim
	C$SpriteBiga.c$42$1_0$179	= .
	.globl	C$SpriteBiga.c$42$1_0$179
;SpriteBiga.c:42: THIS->lim_x = 100;
	...
	ld	(hl+), a
	ld	(hl), #0x00
	C$SpriteBiga.c$43$1_0$179	= .
	.globl	C$SpriteBiga.c$43$1_0$179
;SpriteBiga.c:43: THIS->lim_y = 100;
	...
	ld	(hl+), a
	ld	(hl), #0x00
	C$SpriteBiga.c$44$1_0$179	= .
	.globl	C$SpriteBiga.c$44$1_0$179
;SpriteBiga.c:44: }
	C$SpriteBiga.c$44$1_0$179	= .
	.globl	C$SpriteBiga.c$44$1_0$179
...
_a_biga_up:
	...
	C$SpriteBiga.c$46$1_0$180	= .
	.globl	C$SpriteBiga.c$46$1_0$180
...
_Update_SpriteBiga::
	add	sp, #-10
	C$SpriteBiga.c$47$1_5$180	= .
	.globl	C$SpriteBiga.c$47$1_5$180
;SpriteBiga.c:47: UINT16 final_pos_x = s_horse->x - DISTANCE_X_POSITIVE; //if vx >= 0
	...
	ld	(hl-), a
	ld	(hl), e
	C$SpriteBiga.c$48$1_0$180	= .
	.globl	C$SpriteBiga.c$48$1_0$180
;SpriteBiga.c:48: if (vx < 0){ final_pos_x = s_horse->x + DISTANCE_X_NEGATIVE;}
	...
	push	hl
00102$:
	C$SpriteBiga.c$49$1_5$180	= .
	.globl	C$SpriteBiga.c$49$1_5$180
;SpriteBiga.c:49: UINT16 final_pos_y = s_horse->y - 1; //if vy == 0
	...
	ld	(hl-), a
	ld	(hl), e
	C$SpriteBiga.c$50$1_1$182	= .
	.globl	C$SpriteBiga.c$50$1_1$182
;SpriteBiga.c:50: if(vy < 0){ final_pos_y = s_horse->y + 8;
	...
	jr	00107$
00106$:
	C$SpriteBiga.c$51$1_1$182	= .
	.globl	C$SpriteBiga.c$51$1_1$182
...
00341$:
	...
	ld	(hl), e
00107$:
	C$SpriteBiga.c$53$1_5$180	= .
	.globl	C$SpriteBiga.c$53$1_5$180
;SpriteBiga.c:53: INT16 delta_x = s_horse->x - THIS->x;
	...
	ld	c, e
	ld	b, a
	C$SpriteBiga.c$54$1_2$185	= .
	.globl	C$SpriteBiga.c$54$1_2$185
;SpriteBiga.c:54: UINT8 off_limit_x = 0;
	ldhl	sp,	#9
	ld	(hl), #0x00
	C$SpriteBiga.c$55$1_2$185	= .
	.globl	C$SpriteBiga.c$55$1_2$185
;SpriteBiga.c:55: if(delta_x >= (DISTANCE_X_POSITIVE + DELTA_DISTANCE_MAX)){ //troppo lontano indietro a sinistra! metto un limite
	...
	sbc	a, #0x80
	jr	C, 00109$
	C$SpriteBiga.c$56$2_2$186	= .
	.globl	C$SpriteBiga.c$56$2_2$186
;SpriteBiga.c:56: THIS->x = s_horse->x - (DISTANCE_X_POSITIVE + DELTA_DISTANCE_MAX);
	...
	ld	a, (hl)
	ld	(de), a
	C$SpriteBiga.c$57$2_2$186	= .
	.globl	C$SpriteBiga.c$57$2_2$186
;SpriteBiga.c:57: off_limit_x = 1u;
	ld	(hl), #0x01
00109$:
	C$SpriteBiga.c$59$1_2$185	= .
	.globl	C$SpriteBiga.c$59$1_2$185
...
00343$:
	jr	C, 00111$
	C$SpriteBiga.c$60$2_2$187	= .
	.globl	C$SpriteBiga.c$60$2_2$187
...
;	spillPairReg hl
	...
	ld	a, d
	ld	(bc), a
	C$SpriteBiga.c$61$2_2$187	= .
	.globl	C$SpriteBiga.c$61$2_2$187
;SpriteBiga.c:61: off_limit_x = 1;
	ldhl	sp,	#9
	ld	(hl), #0x01
00111$:
	C$SpriteBiga.c$63$1_2$185	= .
	.globl	C$SpriteBiga.c$63$1_2$185
...
;SpriteBiga.c:53: INT16 delta_x = s_horse->x - THIS->x;
	...
	ld	a, (de)
	ld	b, a
	C$SpriteBiga.c$65$2_2$188	= .
	.globl	C$SpriteBiga.c$65$2_2$188
;SpriteBiga.c:65: if(THIS->x > (final_pos_x+1) ){THIS->x-=2;}
	...
	jr	00118$
00115$:
	C$SpriteBiga.c$66$2_2$188	= .
	.globl	C$SpriteBiga.c$66$2_2$188
...
;SpriteBiga.c:53: INT16 delta_x = s_horse->x - THIS->x;
	...
	ld	c, a
	ld	b, (hl)
	C$SpriteBiga.c$69$1_5$180	= .
	.globl	C$SpriteBiga.c$69$1_5$180
;SpriteBiga.c:69: INT16 delta_y = s_horse->y - THIS->y;
	...
	ld	c, e
	ld	b, a
	C$SpriteBiga.c$70$1_3$191	= .
	.globl	C$SpriteBiga.c$70$1_3$191
;SpriteBiga.c:70: UINT8 off_limit_y = 0;
	ldhl	sp,	#9
	ld	(hl), #0x00
	C$SpriteBiga.c$71$1_3$191	= .
	.globl	C$SpriteBiga.c$71$1_3$191
;SpriteBiga.c:71: if(delta_y >= 30){ //troppo lontano indietro in su! metto un limite
	...
	sbc	a, #0x80
	jr	C, 00120$
	C$SpriteBiga.c$72$2_3$192	= .
	.globl	C$SpriteBiga.c$72$2_3$192
;SpriteBiga.c:72: THIS->y = s_horse->y - 15;
	...
	ld	a, (hl)
	ld	(de), a
	C$SpriteBiga.c$73$2_3$192	= .
	.globl	C$SpriteBiga.c$73$2_3$192
;SpriteBiga.c:73: off_limit_y = 1u;
	ld	(hl), #0x01
00120$:
	C$SpriteBiga.c$75$1_3$191	= .
	.globl	C$SpriteBiga.c$75$1_3$191
;SpriteBiga.c:75: if(delta_y < -30){ //troppo lontano indietro in giù! metto un limite
	...
	sbc	a, #0x7f
	jr	NC, 00122$
	C$SpriteBiga.c$76$2_3$193	= .
	.globl	C$SpriteBiga.c$76$2_3$193
...
;	spillPairReg hl
	...
	ld	a, d
	ld	(bc), a
	C$SpriteBiga.c$77$2_3$193	= .
	.globl	C$SpriteBiga.c$77$2_3$193
;SpriteBiga.c:77: off_limit_y = 1u;
	ldhl	sp,	#9
	ld	(hl), #0x01
00122$:
	C$SpriteBiga.c$80$1_3$191	= .
	.globl	C$SpriteBiga.c$80$1_3$191
...
;SpriteBiga.c:69: INT16 delta_y = s_horse->y - THIS->y;
	...
	ld	a, (de)
	ld	b, a
	C$SpriteBiga.c$81$2_3$194	= .
	.globl	C$SpriteBiga.c$81$2_3$194
;SpriteBiga.c:81: if(THIS->y > final_pos_y){THIS->y--;}
	...
	jr	00129$
00126$:
	C$SpriteBiga.c$82$2_3$194	= .
	.globl	C$SpriteBiga.c$82$2_3$194
;SpriteBiga.c:82: else if (THIS->y < final_pos_y){THIS->y++;}
	...
	ld	(hl), b
00129$:
	C$SpriteBiga.c$84$1_3$191	= .
	.globl	C$SpriteBiga.c$84$1_3$191
...
00346$:
	...
	ld	a, e
	ld	(bc), a
	C$SpriteBiga.c$85$1_3$191	= .
	.globl	C$SpriteBiga.c$85$1_3$191
...
00347$:
	...
	ld	a, (hl)
	ld	(bc), a
	C$SpriteBiga.c$87$1_4$197	= .
	.globl	C$SpriteBiga.c$87$1_4$197
;SpriteBiga.c:87: INT16 to_final_x = THIS->x - final_pos_x;
	...
	ld	c, e
	ld	b, a
	C$SpriteBiga.c$88$1_4$197	= .
	.globl	C$SpriteBiga.c$88$1_4$197
;SpriteBiga.c:88: SetSpriteAnim(THIS, a_biga_h, 1);
	...
	call	_SetSpriteAnim
	pop	bc
	C$SpriteBiga.c$89$1_4$197	= .
	.globl	C$SpriteBiga.c$89$1_4$197
...
00349$:
	jr	NC, 00131$
	C$SpriteBiga.c$90$2_4$198	= .
	.globl	C$SpriteBiga.c$90$2_4$198
;SpriteBiga.c:90: THIS->mirror = V_MIRROR;
	...
	ld	(hl), #0x02
00131$:
	C$SpriteBiga.c$92$1_4$197	= .
	.globl	C$SpriteBiga.c$92$1_4$197
;SpriteBiga.c:92: if(stamina_current < euphoria_max && stamina_current > euphoria_min){
	...
	sbc	a, b
	jr	NC, 00138$
	C$SpriteBiga.c$93$2_4$199	= .
	.globl	C$SpriteBiga.c$93$2_4$199
...
00351$:
	jr	NC, 00135$
	C$SpriteBiga.c$94$3_4$200	= .
	.globl	C$SpriteBiga.c$94$3_4$200
;SpriteBiga.c:94: SetSpriteAnim(THIS, a_biga_down, 12);
	...
	jr	00138$
00135$:
	C$SpriteBiga.c$95$2_4$199	= .
	.globl	C$SpriteBiga.c$95$2_4$199
;SpriteBiga.c:95: }else if (vy < -1){//sto andando in su
	ld	a, (#_vy)
	xor	a, #0x80
	sub	a, #0x7f
	jr	NC, 00138$
	C$SpriteBiga.c$96$3_4$201	= .
	.globl	C$SpriteBiga.c$96$3_4$201
;SpriteBiga.c:96: SetSpriteAnim(THIS, a_biga_up, 12);
	...
	call	_SetSpriteAnim
00138$:
	C$SpriteBiga.c$102$2_5$203	= .
	.globl	C$SpriteBiga.c$102$2_5$203
...
00153$:
	...
	sub	a, (hl)
	jr	Z, 00146$
	C$SpriteBiga.c$103$3_5$204	= .
	.globl	C$SpriteBiga.c$103$3_5$204
;SpriteBiga.c:103: if(CheckCollision(THIS, ibspr)) {
	...
	or	a, a
	jr	Z, 00154$
	C$SpriteBiga.c$104$4_5$205	= .
	.globl	C$SpriteBiga.c$104$4_5$205
;SpriteBiga.c:104: switch(ibspr->type){
	...
	sub	a, #0x08
	jr	NZ, 00154$
	C$SpriteBiga.c$106$6_5$207	= .
	.globl	C$SpriteBiga.c$106$6_5$207
;SpriteBiga.c:106: struct ItemData* item_data = (struct ItemData*) ibspr->custom_data;
	C$SpriteBiga.c$107$6_5$207	= .
	.globl	C$SpriteBiga.c$107$6_5$207
;SpriteBiga.c:107: if(item_data->configured == 2){
	...
	sub	a, #0x02
	jr	NZ, 00154$
	C$SpriteBiga.c$108$7_5$208	= .
	.globl	C$SpriteBiga.c$108$7_5$208
;SpriteBiga.c:108: pickup(ibspr);
	...
	pop	hl
	C$SpriteBiga.c$111$3_5$204	= .
	.globl	C$SpriteBiga.c$111$3_5$204
;SpriteBiga.c:111: }
00154$:
	C$SpriteBiga.c$102$2_5$203	= .
	.globl	C$SpriteBiga.c$102$2_5$203
...
;	spillPairReg hl
	...
	jr	00153$
00146$:
	C$SpriteBiga.c$115$1_5$202	= .
	.globl	C$SpriteBiga.c$115$1_5$202
;SpriteBiga.c:115: if(KEY_TICKED(J_ATK)){
	...
	and	a,(hl)
	jr	NZ, 00155$
	C$SpriteBiga.c$116$2_5$209	= .
	.globl	C$SpriteBiga.c$116$2_5$209
;SpriteBiga.c:116: if(weapon_atk != NONE){
	ld	a, (#_weapon_atk)
	or	a, a
	jr	Z, 00155$
	C$SpriteBiga.c$117$3_5$210	= .
	.globl	C$SpriteBiga.c$117$3_5$210
;SpriteBiga.c:117: use_weapon(0);
	...
	inc	sp
00155$:
	C$SpriteBiga.c$120$1_5$180	= .
	.globl	C$SpriteBiga.c$120$1_5$180
;SpriteBiga.c:120: }
	add	sp, #10
	C$SpriteBiga.c$120$1_5$180	= .
	.globl	C$SpriteBiga.c$120$1_5$180
	...
	G$pickup$0$0	= .
	.globl	G$pickup$0$0
	C$SpriteBiga.c$122$1_5$212	= .
	.globl	C$SpriteBiga.c$122$1_5$212
...
; ---------------------------------
	b_pickup	= 255
_pickup::
	C$SpriteBiga.c$123$1_0$212	= .
	.globl	C$SpriteBiga.c$123$1_0$212
;SpriteBiga.c:123: struct ItemData* item_data = (struct ItemData*) s_arg_item->custom_data;
	...
	ld	hl, #0x001b
	add	hl, de
	C$SpriteBiga.c$124$1_0$212	= .
	.globl	C$SpriteBiga.c$124$1_0$212
...
00126$:
	...
	jp	00107$
	jp	00108$
	C$SpriteBiga.c$125$2_0$213	= .
	.globl	C$SpriteBiga.c$125$2_0$213
;SpriteBiga.c:125: case GLADIO: case LANCE: case FLAME:
00103$:
	C$SpriteBiga.c$126$2_0$213	= .
	.globl	C$SpriteBiga.c$126$2_0$213
;SpriteBiga.c:126: weapon_atk = item_data->itemtype;
	ld	hl, #_weapon_atk
	ld	(hl), c
	C$SpriteBiga.c$127$2_0$213	= .
	.globl	C$SpriteBiga.c$127$2_0$213
;SpriteBiga.c:127: update_weapon();
	...
	call	___sdcc_bcall_ehl
	pop	de
	C$SpriteBiga.c$128$2_0$213	= .
	.globl	C$SpriteBiga.c$128$2_0$213
;SpriteBiga.c:128: break;
	jp	_SpriteManagerRemoveSprite
	C$SpriteBiga.c$129$2_0$213	= .
	.globl	C$SpriteBiga.c$129$2_0$213
;SpriteBiga.c:129: case ELMET: case SHIELD: case CAPE:
00106$:
	C$SpriteBiga.c$130$2_0$213	= .
	.globl	C$SpriteBiga.c$130$2_0$213
;SpriteBiga.c:130: weapon_def = item_data->itemtype;
	ld	hl, #_weapon_def
	ld	(hl), c
	C$SpriteBiga.c$131$2_0$213	= .
	.globl	C$SpriteBiga.c$131$2_0$213
;SpriteBiga.c:131: update_weapon();
	...
	call	___sdcc_bcall_ehl
	pop	de
	C$SpriteBiga.c$132$2_0$213	= .
	.globl	C$SpriteBiga.c$132$2_0$213
;SpriteBiga.c:132: break;
	jp	_SpriteManagerRemoveSprite
	C$SpriteBiga.c$133$2_0$213	= .
	.globl	C$SpriteBiga.c$133$2_0$213
;SpriteBiga.c:133: case HP:
00107$:
	C$SpriteBiga.c$134$2_0$213	= .
	.globl	C$SpriteBiga.c$134$2_0$213
;SpriteBiga.c:134: update_hp_max();
	...
	call	___sdcc_bcall_ehl
	pop	de
	C$SpriteBiga.c$135$2_0$213	= .
	.globl	C$SpriteBiga.c$135$2_0$213
;SpriteBiga.c:135: break;
	jp	_SpriteManagerRemoveSprite
	C$SpriteBiga.c$136$2_0$213	= .
	.globl	C$SpriteBiga.c$136$2_0$213
;SpriteBiga.c:136: case TIME:
00108$:
	C$SpriteBiga.c$137$2_0$213	= .
	.globl	C$SpriteBiga.c$137$2_0$213
;SpriteBiga.c:137: update_time_max();
	...
	call	___sdcc_bcall_ehl
	pop	de
	C$SpriteBiga.c$139$1_0$212	= .
	.globl	C$SpriteBiga.c$139$1_0$212
;SpriteBiga.c:139: }    
	C$SpriteBiga.c$140$1_0$212	= .
	.globl	C$SpriteBiga.c$140$1_0$212
;SpriteBiga.c:140: SpriteManagerRemoveSprite(s_arg_item);
	C$SpriteBiga.c$141$1_0$212	= .
	.globl	C$SpriteBiga.c$141$1_0$212
;SpriteBiga.c:141: }
	C$SpriteBiga.c$141$1_0$212	= .
	.globl	C$SpriteBiga.c$141$1_0$212
	XG$pickup$0$0	= .
	...
	C$SpriteBiga.c$143$1_0$215	= .
	.globl	C$SpriteBiga.c$143$1_0$215
;SpriteBiga.c:143: void DESTROY() {
;	---------------------------------
; Function Destroy_SpriteBiga
; ---------------------------------
_Destroy_SpriteBiga::
	C$SpriteBiga.c$144$1_0$215	= .
	.globl	C$SpriteBiga.c$144$1_0$215
;SpriteBiga.c:144: }
	C$SpriteBiga.c$144$1_0$215	= .
	.globl	C$SpriteBiga.c$144$1_0$215
