...
;--------------------------------------------------------
	...
	C$OAMManager.c$21$0_0$184	= .
	.globl	C$OAMManager.c$21$0_0$184
;C:/ZGB-2023.0/common/src/OAMManager.c:21: void SwapOAMs() {
;	---------------------------------
; Function SwapOAMs
; ---------------------------------
_SwapOAMs::
	C$OAMManager.c$23$1_0$184	= .
	.globl	C$OAMManager.c$23$1_0$184
...
;	spillPairReg hl
	...
	ld	a, (hl)
	adc	a, b
	C$OAMManager.c$24$2_0$185	= .
	.globl	C$OAMManager.c$24$2_0$185
;C:/ZGB-2023.0/common/src/OAMManager.c:24: UINT8* tmp = oam;
	ld	(hl-), a
	ld	a, (hl+)
	ld	c, a
	ld	b, (hl)
	C$OAMManager.c$25$1_1$185	= .
	.globl	C$OAMManager.c$25$1_1$185
...
00101$:
	...
	sbc	a, (hl)
	jr	NC, 00103$
	C$OAMManager.c$26$2_1$186	= .
	.globl	C$OAMManager.c$26$2_1$186
;C:/ZGB-2023.0/common/src/OAMManager.c:26: *oam = 0;
	ld	hl, #_oam
	ld	a, (hl+)
	ld	e, a
	C$OAMManager.c$27$2_1$186	= .
	.globl	C$OAMManager.c$27$2_1$186
;C:/ZGB-2023.0/common/src/OAMManager.c:27: oam += 4;
	...
	jr	00101$
00103$:
	C$OAMManager.c$30$1_1$185	= .
	.globl	C$OAMManager.c$30$1_1$185
...
;c:\zgb-2023.0\env\gbdk\include\gb\gb.h:1784: _shadow_OAM_base = (uint8_t)((uint16_t)address >> 8);
	...
	C$OAMManager.c$32$2_1$187	= .
	.globl	C$OAMManager.c$32$2_1$187
;C:/ZGB-2023.0/common/src/OAMManager.c:32: oam0 = tmp;
	ld	hl, #_oam0
	ld	a, c
	ld	(hl+), a
	ld	(hl), b
	C$OAMManager.c$33$2_1$187	= .
	.globl	C$OAMManager.c$33$2_1$187
;C:/ZGB-2023.0/common/src/OAMManager.c:33: oam = (UINT8*)OAM_MIRROR_ADDRESS;
	ld	hl, #_oam
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0xdf
	C$OAMManager.c$34$2_1$187	= .
	.globl	C$OAMManager.c$34$2_1$187
...
;c:\zgb-2023.0\env\gbdk\include\gb\gb.h:1784: _shadow_OAM_base = (uint8_t)((uint16_t)address >> 8);
	ld	a, #0xdf
	ldh	(__shadow_OAM_base + 0), a
	C$OAMManager.c$37$2_1$188	= .
	.globl	C$OAMManager.c$37$2_1$188
;C:/ZGB-2023.0/common/src/OAMManager.c:37: oam1 = tmp;
	ld	hl, #_oam1
	ld	a, c
	ld	(hl+), a
	ld	(hl), b
	C$OAMManager.c$38$2_1$188	= .
	.globl	C$OAMManager.c$38$2_1$188
;C:/ZGB-2023.0/common/src/OAMManager.c:38: oam = (UINT8*)0xC000;
	ld	hl, #_oam
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0xc0
	C$OAMManager.c$39$2_1$188	= .
	.globl	C$OAMManager.c$39$2_1$188
;C:/ZGB-2023.0/common/src/OAMManager.c:39: oam_end = oam0;
	...
	ld	(#_oam_end + 1),a
00106$:
	C$OAMManager.c$41$1_1$185	= .
	.globl	C$OAMManager.c$41$1_1$185
;C:/ZGB-2023.0/common/src/OAMManager.c:41: __render_shadow_OAM = ((UWORD)oam) >> 8;
	...
	ld	(hl), c
	C$OAMManager.c$42$1_1$185	= .
	.globl	C$OAMManager.c$42$1_1$185
;C:/ZGB-2023.0/common/src/OAMManager.c:42: next_oam_idx = 0;
	ld	hl, #_next_oam_idx
	ld	(hl), #0x00
	C$OAMManager.c$44$1_1$185	= .
	.globl	C$OAMManager.c$44$1_1$185
;C:/ZGB-2023.0/common/src/OAMManager.c:44: scroll_x_vblank = scroll_x;
	ld	a, (#_scroll_x)
	ld	(#_scroll_x_vblank),a
	C$OAMManager.c$45$1_1$185	= .
	.globl	C$OAMManager.c$45$1_1$185
;C:/ZGB-2023.0/common/src/OAMManager.c:45: scroll_y_vblank = scroll_y;
	ld	a, (#_scroll_y)
	ld	(#_scroll_y_vblank),a
	C$OAMManager.c$46$1_1$184	= .
	.globl	C$OAMManager.c$46$1_1$184
;C:/ZGB-2023.0/common/src/OAMManager.c:46: }
	...
	C$OAMManager.c$48$1_1$195	= .
	.globl	C$OAMManager.c$48$1_1$195
;C:/ZGB-2023.0/common/src/OAMManager.c:48: void ClearOAMs() {
;	---------------------------------
; Function ClearOAMs
; ---------------------------------
_ClearOAMs::
	C$OAMManager.c$49$1_0$195	= .
	.globl	C$OAMManager.c$49$1_0$195
;C:/ZGB-2023.0/common/src/OAMManager.c:49: oam0 = (UINT8*)0xC000;
	ld	hl, #_oam0
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0xc0
	C$OAMManager.c$50$1_0$195	= .
	.globl	C$OAMManager.c$50$1_0$195
;C:/ZGB-2023.0/common/src/OAMManager.c:50: oam1 = (UINT8*)OAM_MIRROR_ADDRESS;
	ld	hl, #_oam1
	xor	a, a
	ld	(hl+), a
	ld	(hl), #0xdf
	C$OAMManager.c$51$1_0$195	= .
	.globl	C$OAMManager.c$51$1_0$195
;C:/ZGB-2023.0/common/src/OAMManager.c:51: memset(oam0, 0, sizeof(oam_mirror));
	...
	call	_memset
	add	sp, #6
	C$OAMManager.c$52$1_0$195	= .
	.globl	C$OAMManager.c$52$1_0$195
;C:/ZGB-2023.0/common/src/OAMManager.c:52: memset(oam1, 0, sizeof(oam_mirror));
	...
	call	_memset
	add	sp, #6
	C$OAMManager.c$53$1_0$195	= .
	.globl	C$OAMManager.c$53$1_0$195
;C:/ZGB-2023.0/common/src/OAMManager.c:53: next_oam_idx = 0;
	ld	hl, #_next_oam_idx
	ld	(hl), #0x00
	C$OAMManager.c$54$1_0$195	= .
	.globl	C$OAMManager.c$54$1_0$195
