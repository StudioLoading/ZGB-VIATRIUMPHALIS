...
const UINT8 a_configwhip_blink[] = {2, 0,1};
const UINT8 a_configwhip[] = {1,1};

void item_configwhip_anim_blink(Sprite* s_item_arg) BANKED;
void item_configwhip_anim(Sprite* s_item_arg) BANKED;
...
void item_configwhip_anim_blink(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_configwhip_blink, 32);
}

void item_configwhip_anim(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_configwhip, 32);
}
