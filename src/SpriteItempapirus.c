...
const UINT8 a_papirus_blink[] = {2, 0,1};
const UINT8 a_papirus[] = {1, 1};

void item_papirus_anim_blink(Sprite* s_item_arg) BANKED;
void item_papirus_anim(Sprite* s_item_arg) BANKED;
...
void item_papirus_anim_blink(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_papirus_blink, 32);
}

void item_papirus_anim(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_papirus, 32);
}
