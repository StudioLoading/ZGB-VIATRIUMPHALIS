...
const UINT8 a_heart_blink[] = {2, 0,1};
const UINT8 a_heart[] = {1,1};

void item_heart_anim_blink(Sprite* s_item_arg) BANKED;
void item_heart_anim(Sprite* s_item_arg) BANKED;
...
void item_heart_anim_blink(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_heart_blink, 80);
}

void item_heart_anim(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_heart, 32);
}
