...
const UINT8 a_fire_blink[] = {2, 0,1};
const UINT8 a_fire[] = {1,1};

void item_fire_anim_blink(Sprite* s_item_arg) BANKED;
void item_fire_anim(Sprite* s_item_arg) BANKED;
...
void item_fire_anim_blink(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_fire_blink, 32);
}

void item_fire_anim(Sprite* s_item_arg) BANKED{
    SetSpriteAnim(s_item_arg, a_fire, 32);
}
